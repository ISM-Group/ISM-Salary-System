...
router.post('/', (0, rbac_middleware_1.authorize)(types_1.UserRole.ADMIN, types_1.UserRole.MANAGER), (0, auditLog_middleware_1.auditLog)('employees', auditLog_1.AuditAction.CREATE), employees_controller_1.createEmployee);
