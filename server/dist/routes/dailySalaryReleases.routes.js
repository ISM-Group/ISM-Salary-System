...
router.post('/generate', (0, rbac_middleware_1.authorize)(types_1.UserRole.ADMIN, types_1.UserRole.MANAGER), dailySalaryReleases_controller_1.generateDailyReleases);
...
router.put('/release-all', (0, rbac_middleware_1.authorize)(types_1.UserRole.ADMIN), dailySalaryReleases_controller_1.releaseAllDailySalaries);
