...
router.post('/register', auth_middleware_1.authenticate, (0, rbac_middleware_1.authorize)(types_1.UserRole.ADMIN), (0, validate_middleware_1.validate)(schemas_1.registerSchema), auth_controller_1.register);
