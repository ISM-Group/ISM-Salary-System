...
router.post('/', (0, rbac_middleware_1.authorize)(types_1.UserRole.ADMIN), holidays_controller_1.createHoliday);
// Update holiday (ADMIN only, audit logged in controller with role attribution)
router.put('/:id', (0, rbac_middleware_1.authorize)(types_1.UserRole.ADMIN), holidays_controller_1.updateHoliday);
// Update employee assignments for a holiday (ADMIN only, audit logged in controller with role attribution)
router.put('/:id/employees', (0, rbac_middleware_1.authorize)(types_1.UserRole.ADMIN), holidays_controller_1.updateHolidayEmployees);
