...
function thisMonthEnd() {
  const d = new Date(); return localDateStr(new Date(d.getFullYear(), d.getMonth() + 1, 0));
}
function thisWeekStart() {
  const d = new Date(); const day = d.getDay() || 7; d.setDate(d.getDate() - day + 1); return localDateStr(d);
}
function thisWeekEnd() {
  const d = new Date(); const day = d.getDay() || 7; d.setDate(d.getDate() - day + 7); return localDateStr(d);
}
