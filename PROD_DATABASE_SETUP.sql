-- =====================================================
-- ISM Salary System - Production Database Seeding
-- =====================================================
-- Safe for production: Creates tables only if not exists
-- Does NOT drop or truncate existing data
-- Usage: Run in MySQL Workbench or:
--   mysql -u mrfawz_user -p ISM_salary < PROD_DATABASE_SETUP.sql
--
-- Important: Set timezone to +05:30 (Sri Lanka)
-- =====================================================
...
SELECT CONCAT(COUNT(*), ' tables created/verified') AS Summary
FROM information_schema.TABLES 
WHERE TABLE_SCHEMA = DATABASE()
AND TABLE_NAME IN (
  'departments', 'users', 'roles', 'employees', 'attendance',
  'loans', 'loan_installments', 'advance_salaries', 'salary_calculations',
  'employee_salary_history', 'holidays', 'holiday_employees',
  'daily_salary_releases', 'audit_logs'
);
